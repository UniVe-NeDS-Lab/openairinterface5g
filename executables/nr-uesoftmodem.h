...
#define CMDLINE_NRUEPARAMS_DESC                                                                                                                                                                        \
  {                                                                                                                                                                                                    \
    {"usrp-args", CONFIG_HLP_USRP_ARGS, 0, strptr : &usrp_args, defstrval : "type=b200", TYPE_STRING, 0},                                                                                              \
        ...
        {"V", CONFIG_HLP_VCD, PARAMFLAG_BOOL, iptr : &vcdflag, defintval : 0, TYPE_INT, 0}, {"uecap_file", CONFIG_HLP_UECAP_FILE, 0, strptr : &uecap_file, defstrval : "./uecap.xml", TYPE_STRING, 0}, \
...
#define CMDLINE_NRUE_PHYPARAMS_DESC                                                                                                                                                                    \
  {                                                                                                                                                                                                    \
    {CALIBRX_OPT, CONFIG_HLP_CALUER, 0, iptr : &rx_input_level_dBm, defintval : 0, TYPE_INT, 0}, {CALIBRXMED_OPT, CONFIG_HLP_CALUERM, 0, iptr : &rx_input_level_dBm, defintval : 0, TYPE_INT, 0},      \
        {CALIBRXBYP_OPT, CONFIG_HLP_CALUERB, 0, iptr : &rx_input_level_dBm, defintval : 0, TYPE_INT, 0}, {DBGPRACH_OPT, CONFIG_HLP_DBGUEPR, PARAMFLAG_BOOL, uptr : NULL, defuintval : 1, TYPE_INT, 0}, \
        ...
        {"ue-max-power", NULL, 0, iptr : &(tx_max_power[0]), defintval : 90, TYPE_INT, 0}, {"A", CONFIG_HLP_TADV, 0, iptr : &(UE->timing_advance), defintval : 0, TYPE_INT, 0},                        \
        ...
        {"s", CONFIG_HLP_SSC, 0, u16ptr : &(fp->ssb_start_subcarrier), defintval : 516, TYPE_UINT16, 0}, {"T", CONFIG_HLP_TDD, PARAMFLAG_BOOL, iptr : &tddflag, defintval : 0, TYPE_INT, 0},           \
        ...
        {"chest-freq", CONFIG_HLP_CHESTFREQ, 0, iptr : &(UE->chest_freq), defintval : 0, TYPE_INT, 0}, {"chest-time", CONFIG_HLP_CHESTTIME, 0, iptr : &(UE->chest_time), defintval : 0, TYPE_INT, 0},  \
...
extern NR_UE_RRC_INST_t *init_NR_UE(int, char *, char *);
